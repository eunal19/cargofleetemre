...
import { openNewDriverDialog, setDriversSearchText } from './store/driversSlice';
...
function DriversHeader(props) {
  ...
  return (
    <div className="flex flex-1 items-center justify-between p-4 sm:p-24">
      ...
      <Button
        onClick={() => {
          dispatch(openNewDriverDialog());
        }}
        variant="contained"
        size="large"
        sx={{
          '&.MuiButton-contained': { backgroundColor: 'rgb(240, 247, 247)' }
        }}
      >
        Add new
      </Button>
